# AGENTS.md — cybersecurity-series

## Project summary

Umbrella repository for nlink-jp's AI-augmented security tools — threat
intelligence, incident response analysis, and OSINT lookups. Each tool
lives in its own repository, included here as a submodule. The catalog —
one row per tool — is [README.md](README.md); this file covers only how to
...
| Command | Purpose |
|---------|---------|
| `git clone --recurse-submodules https://github.com/nlink-jp/cybersecurity-series.git` | Clone with all tools |
...
Repository: `github.com/nlink-jp/cybersecurity-series`
